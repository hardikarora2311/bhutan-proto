...
const Lineage2 = ({menuHandle, fromMenu}) => {
        ...
        if (menuHandle===2 || menuHandle===3){
            ...
            <div className="lineage-wrapper">
                {(()=>{
                    if (fromMenu===1){
                        return <>
                       <div className={(menuHandle>=2 && menuHandle<4)? ( menuHandle===2? "text-box-2 text-box-2-his text-box text-box-share text-box-clrd":"text-box text-box-2 text-box-share text-box-clrd slide-out-blurred-top"): ("text-box text-box-share text-box-clrd text-box-2 v-hidden") }>
                    <h1 className='animate__animated focus-in-expand animate__delay-4s'>LINEAGE</h1>
                    <hr></hr>
                    <p className='animate__animated focus-in-expand animate__delay-5s'>Pema Lingpa’s lineage is maintained by his three incarnation lines – Peling Sungtrul from his direct incarnation, Peling Tukse from his son and Gangteng Trulku from his grandson. Ganteng Trulku Rinpoche is the authentic representative of Peling tradition with the Gangtey monastery in Phubjikha Valley serving as his seat. Pema Lingpa’s sons also established important noble families in Bhutan, namely Tamzhing Choeji of Bumthang and Dungkhar Choeji of Kurtoe. His descendants played a major part in the unification of Bhutan in the 17th century. Jigme Namgyel, the forefather of the ruling Wangchuck dynasty was born into the family of Dungkhar Choeji founded by Pema Lingpa’s son Kunga Wangpo.</p>
                </div>
                        </>
                      }else{
                        return <>
                        <div className={(menuHandle>=2 && menuHandle<4)? ( menuHandle===2? "text-box-2 text-box text-box-share text-box-clrd":"text-box text-box-2 text-box-share text-box-clrd slide-out-blurred-top"): ("text-box text-box-share text-box-clrd text-box-2 v-hidden") }>
                        <h1 className='animate__animated focus-in-expand animate__delay-4s'>LINEAGE</h1>
                        <hr></hr>
                        <p className='animate__animated focus-in-expand animate__delay-5s'>Pema Lingpa’s lineage is maintained by his three incarnation lines – Peling Sungtrul from his direct incarnation, Peling Tukse from his son and Gangteng Trulku from his grandson. Ganteng Trulku Rinpoche is the authentic representative of Peling tradition with the Gangtey monastery in Phubjikha Valley serving as his seat. Pema Lingpa’s sons also established important noble families in Bhutan, namely Tamzhing Choeji of Bumthang and Dungkhar Choeji of Kurtoe. His descendants played a major part in the unification of Bhutan in the 17th century. Jigme Namgyel, the forefather of the ruling Wangchuck dynasty was born into the family of Dungkhar Choeji founded by Pema Lingpa’s son Kunga Wangpo.</p>
                    </div>
                ...
                <div className={(menuHandle>=2 && menuHandle<4)? ( menuHandle===2? "familytree animate__animated animate__fadeIn animate__delay-5s":"animate__animated animate__fadeOut familytree-2"): ("animate__animated animate__fadeOut familytree-2 v-hidden") }>
