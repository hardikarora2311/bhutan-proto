...
const Revelations = ({menuHandle, setMenuHandle}) => {
    if (menuHandle===3){
        ...
        <div className="animate__animated animate__zoomIn animate__delay-1s text-box text-box-clrd text-box-share" style={{height: "302px"}}>
            <h1 className='animate__animated animate__fadeIn animate__delay-2s'>Revelations by pema lingpa</h1>
            <hr></hr>
            <p className='animate__animated animate__fadeIn animate__delay-3s'>Pema Lingpa discovered treasures mainly around Bumthang’s valleys and regions north of its current borders with Tibet. He revealed exclusively physical terma, both texts and relics. In his lifetime, Pema Lingpa was able to reveal only 32 out of 108 termas destined for him. The collection of texts discovered by him, ‘The Precious Collection of Profound Treasure Teachings of the Great Master Pema Lingpa’ consists of 21 volumes.</p>
        </div>
        <div className="comic-submenu">
            <div className="submenu-clickable animate__animated animate__fadeInLeft animate__delay-4s" onClick={()=> setMenuHandle(3.1)}>
                <div className='comic-title'>REVELATIONS AT <br></br><span>NARING DRAG</span></div>
                <img className='comic-cover' src={comic1} alt="" />  
            </div>
            <div className="submenu-clickable submenu-clickable-reverse animate__animated animate__fadeInRight animate__delay-5s" onClick={()=> setMenuHandle(3.2)}>
                <div className="comic-title">REVELATIONS AT <br></br><span>BURNING LAKE</span></div>
