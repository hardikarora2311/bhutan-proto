...
const Legacy = ({menuHandle, setMenuHandle}) => {
    if (menuHandle===4){
      ...
      if (menuHandle===4.1){
        return (
        <div className="lineage-wrapper">
        <div className=" animate__animated animate__zoomIn animate__delay-1s text-box text-box-share text-box-light" style={{height: "320px"}}>
            <h1 className='animate__animated animate__fadeIn animate__delay-2s' style={{fontSize: "32px"}}>Peling<br></br><b style={{fontSize: "48px"}}>Monasteries & Temples</b></h1>
            <hr></hr>
