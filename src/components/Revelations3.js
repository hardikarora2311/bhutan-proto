    ...
    if (menuHandle === 3 || menuHandle===4) {
      ...
      if (menuHandle === 3.1) {
        return (
          <div className="lineage-wrapper">
            <div
              className="text-box text-box-share text-box-light text-box-3"
              style={{ height: "375px" , animation: "leftEdgeAnimationShare375 2s forwards"}}
            >
              <h1
                className="animate__animated slide-right animate__delay-3s"
                style={{ fontSize: "32px" }}
              >
                Revelations At <br></br>
              ...
              <hr></hr>
              <p className="animate__animated slide-right animate__delay-4s">
            ...
            <div className="comic-main animate__animated slide-right animate__delay-4s">
              <img
                src={cover1}
                alt=""
