...
const History2 = ({menuHandle, fromMenu}) => {
    if (menuHandle===1 || menuHandle===2){
        return (
            ...
            if (fromMenu===1){
              return <>
             <div className={(menuHandle>=1 && menuHandle<3)? ( menuHandle===1? "text-box text-box-2-his text-box-clrd":"text-box text-box-clrd text-box-2 slide-out-blurred-top"): ("text-box text-box-clrd text-box-2 v-hidden") }>
